...
<div class="page-header">
    <h1>
        ...
        <small class="pull-right">
            <a href="${ctx}/dashboard/data/dictionary/create" class="btn btn-sm btn-inverse" data-backdrop="static" data-toggle="modal"
...
<table id="dictionary-table" class="table table-striped table-bordered table-hover">
    ...
    <@c.pagination url="${ctx}/dashboard/data/dictionary" param="type=${type}&value=${value}"/>

<script src="${ctx}/static/app/js/dashboard/data/dictionary/list.js"></script>
