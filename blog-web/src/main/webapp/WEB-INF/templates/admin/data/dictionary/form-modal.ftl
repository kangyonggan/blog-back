...
<form class="form-horizontal" role="form" id="modal-form" method="post"
      action="${ctx}/admin/data/dictionary/${dictionary.id???string('update', 'save')}">
    <div class="row">
...
<button class="btn btn-sm btn-primary" id="dictionary-btn"
        data-loading-text="正在保存..." data-toggle="form-submit" data-target="#modal-form">
    <i class="ace-icon fa fa-check"></i>
    <@spring.message "app.button.save"/>
</button>

<script src="${ctx}/static/app/js/admin/data/dictionary/form-modal.js"></script>
</@override>
